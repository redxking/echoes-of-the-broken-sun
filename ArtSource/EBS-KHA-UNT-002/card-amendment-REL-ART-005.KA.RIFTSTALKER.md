...
| 9 | `fl_lower` | `fl_upper` | (4, -82, 97) | fl leg: lower segment, pivoting at the knee |
...
| 13 | `fr_lower` | `fr_upper` | (4, 82, 97) | fr leg: lower segment, pivoting at the knee |
...
| 17 | `rl_lower` | `rl_upper` | (-106, -82, 106) | rl leg: lower segment, pivoting at the knee |
...
| 21 | `rr_lower` | `rr_upper` | (-106, 82, 106) | rr leg: lower segment, pivoting at the knee |
