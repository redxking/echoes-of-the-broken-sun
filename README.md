...
**Current state:** This is a verified Unreal playable-systems prototype moving into its Glass Scar vertical slice, not a completed game. Version 0.35.0 retains distinct deterministic identities and production for all sixteen named Meridian Compact and Kharuun Assemblies slice archetypes and implements three bounded faction mechanics. Meridian Bulwarks deploy directional cover, and connected Relay Skiffs temporarily extend Logistics. Kharuun Waystones now root to provide Logistics, spend 40 ticks uprooting, migrate at an authored 120 cm/s without providing capacity, take 25 percent additional damage while exposed, and require 60 uninterrupted ticks on a clear passable footprint to root again. The canonical content SHA-256 is `13d939a3f3c720c6c56adaf06c7fef43a31f3c9e1916822660951e51fc71843b`; rules, schema-14 snapshots/replays, player views, AI observations, and checksums carry all three profiles and public states. The deterministic core passes 22/22 suites in optimized, debug, and sanitizer configurations; the arm64 Development Editor builds; Unreal automation passes 16/16 without warnings or errors; and normal plus 400-unit/four-team runtime gates remain green. `Backslash`, `Equals`, and `Hyphen` control Bulwark deployment, Relay supply, and Waystone state respectively; world proxies expose each public state. The complete-roster scenario now contains its previously omitted Kharuun Waystone and 32 total entities. Warform adaptation, Cairnback temporary cover, Resonant/Listening Spine detection, powered Aegis behavior, and broader faction systems remain unimplemented. Campaign, multiplayer, and replay UI remain hidden. The latest accepted package remains clean-source 0.23.1 at commit `98a9b83`; version 0.35.0 has not been packaged or profiled because storage remains at the packaging floor without safe transient margin. Final effects, formations, complete pointer interaction, a rendered end-to-end player-driven match, networked multiplayer, clean-machine use, Developer ID signing, notarization, final art/audio, complete accessibility/settings implementation, and release qualification remain open.
...
2. Keep full Xcode selected. Xcode 26.6 has passed project generation, arm64 editor compilation, sixteen Unreal automation tests, null-RHI startup for both normal and 400-unit/four-team fixtures, and local Development cooking/packaging; Epic still recommends 26.1.1, and clean-machine use remains unverified.
