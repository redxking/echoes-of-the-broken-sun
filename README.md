...
**Current state:** This is a verified Unreal playable-systems prototype moving into its Glass Scar vertical slice, not a completed game. Version 0.51.0 adds the first authored battlefield-composition pass: seven non-colliding fracture bands, twelve shard silhouettes, and five shadow-free local lights form a magenta/copper seam across the authoritative broken span. The fair fog layer continues to mask unrevealed terrain, and the new presentation actors have no collision or simulation authority. Version 0.50.0 retains F7 combat-force selection, selected-group camera/reticle snap, the bounded Adaptive opening posture, completed construction/production and two-faction research paths, five-unit Hold, control-group assignment/recall, five formation-spaced Patrol routes, and one bounded player-driven victory/result/redeploy operation. Source commit `83e53720b1e0357cc972567e141ebfc140831ebd` passes 27/27 content tests, 27/27 deterministic suites in optimized, debug, and sanitizer configurations, the arm64 Development Editor build, 22/22 Unreal automation tests without warnings or errors, and normal Meridian and Kharuun runtime starts. The canonical content SHA-256 remains `100f1fcd184cf94fe9b21d3f591714a2e33cc92b60f018bc6523868675156fa0`. This accepts the named code-only terrain composition and rendered Scar view, not final terrain art, broad balance, performance, or usability qualification. Exact coordinate-click delivery, ordinary player-driven research interruption, authored unit/effect/audio presentation, and release qualification remain unaccepted. Campaign, multiplayer, and replay UI remain hidden. The latest accepted package remains clean-source 0.23.1 at commit `98a9b83`; version 0.51.0 has not been packaged or profiled because about 54 GiB is free, below the 60 GiB packaging floor. Final effects, formations, networked multiplayer, clean-machine use, Developer ID signing, notarization, final art/audio, complete accessibility/settings implementation, and release qualification remain open.
...
3. Retain exact coordinate-pointer delivery as a separate acceptance gate, exercise ordinary player-driven research interruption, and continue replacing technical primitives with authored unit silhouettes, effects, terrain, interface, and audio under the performance, provenance, and accessibility gates. The first code-only Scar composition is accepted at version 0.51.0; it is not final terrain art. The bounded keyboard-driven construction, production, research-completion, Future Well, tactical-control, victory, result, and post-result restart paths remain accepted at version 0.50.0.
