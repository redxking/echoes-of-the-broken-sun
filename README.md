...
**Current state:** This is a verified Unreal playable-systems prototype moving into its Glass Scar vertical slice, not a completed game. Version 0.31.0 replaces the foundational technical-fixture statistics with deterministic rules compiled from the authored catalog for each faction's worker, line combatant, headquarters, logistics structure, production structure, and Future Well economy. Costs, health, movement, sight, attacks, work rate, cargo, population, production/construction timing, capacity, footprints, and Well rewards/durations now affect live simulation state. Rules version 1 and canonical content SHA-256 `46bc07c2f792417f880c988b053c2ac825013b695787b0e49da95ebddf92e949` are embedded in schema-10 snapshots, replays, and checksums; match startup fails closed if stable-ID bindings or the digest are invalid. The deterministic core passes 18/18 suites in optimized, debug, and sanitizer configurations, the arm64 Development Editor builds, Unreal automation passes 13/13 without warnings or errors, and both normal and 400-unit runtime gates load the authored rules. The complete eight-unit/eight-structure roster remains defined, but Bulwark, Relay Skiff, Cairnback, Resonant, Aegis Post, and Listening Spine do not yet have distinct simulation entity types or special mechanics. Deployment, cover, mobile rooting, adaptation, and vibration detection remain unimplemented. Campaign, multiplayer, and replay UI remain hidden. Presentation is unchanged from the bounded 0.27.0 Metal inspection. The latest accepted package remains clean-source 0.23.1 at commit `98a9b83`; version 0.31.0 has not been packaged or profiled. Final effects, formations, complete pointer interaction, a rendered end-to-end player-driven match, networked multiplayer, clean-machine use, Developer ID signing, notarization, final art/audio, complete accessibility/settings implementation, and release qualification remain open.
