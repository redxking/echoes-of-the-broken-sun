...
**Current state:** This is a verified Unreal playable-systems prototype moving into its Glass Scar vertical slice, not a completed game. Version 0.41.0 adds four canonical faction technologies: two sequential Meridian upgrades and two sequential Kharuun upgrades. Research has explicit costs, prerequisites, structure occupancy, progress, completion, current/future-unit effects, destroyed-producer interruption without refund, save/replay persistence, checksum coverage, fair-view AI access, stable failure feedback, a `Shift+R` command, and HUD progress. The selected faction and visibility-scoped Adaptive opposition introduced in 0.40.0 remain intact. The canonical content SHA-256 is `100f1fcd184cf94fe9b21d3f591714a2e33cc92b60f018bc6523868675156fa0`; snapshot/replay schema is 19. At clean commit `3e77039534f6c449088d00c543f092614ca74ffc`, 27/27 content tests passed, the deterministic core passed 27/27 suites in optimized, debug, and sanitizer configurations, the arm64 Development Editor built, Unreal automation passed 22/22 without warnings or errors, both 32-entity faction directions booted under null RHI, and the 400-unit/four-team runtime gate remained green. A 1600×900 Metal session visibly accepted the idle `RESEARCH 0/2` status and `Shift+R` guidance without observed clipping or overlap. It did not execute or visually accept active research progress. The external desktop bridge still closes during coordinate interaction, so pointer selection, rendered research execution, rendered Kharuun contact legibility, a complete player-driven match, and balance remain unaccepted. Campaign, multiplayer, and replay UI remain hidden. The latest accepted package remains clean-source 0.23.1 at commit `98a9b83`; version 0.41.0 has not been packaged or profiled because the current 65 GiB free space is only about 5 GiB above the packaging floor and remains an unsafe transient margin. Final effects, formations, networked multiplayer, clean-machine use, Developer ID signing, notarization, final art/audio, complete accessibility/settings implementation, and release qualification remain open.
...
Unreal Engine 5.8.2 is installed at `/Users/Shared/Epic Games/UE_5.8` and its completed launcher manifest has been inspected. The separately delivered Apple Metal Toolchain is installed. The host is a 16 GB M1 Pro Mac with about 65 GiB free at the 0.41.0 source-evidence checkpoint. That is only about 5 GiB above the project's 60 GiB packaging floor and still provides no safe transient margin; the safer sustained-production target is 100 GiB. Rebuildable staging trees and superseded packages remain recoverable in Trash and still occupy space until Trash is emptied. New packaging remains deferred until meaningful headroom is reclaimed. A verified official launcher-installer backup exists at `~/Downloads/EpicInstaller-20.1.4.dmg`, but it should not replace the newer installed launcher.
