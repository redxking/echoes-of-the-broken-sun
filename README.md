...
3. Package and profile the 0.12.0 build for Unreal frame, GPU, and resident-memory cost; qualify four-team fog and a 60-minute soak; and complete pointer-driven construction, production, movement, combat, victory, and restart validation as one rendered match before content expansion.
