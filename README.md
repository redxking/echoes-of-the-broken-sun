...
3. Retain exact coordinate-pointer delivery as a separate acceptance gate, exercise ordinary player-driven research completion/interruption, and replace technical primitives and procedural atmosphere with an authored vertical-slice roster, effects, terrain, interface, and audio under the performance, provenance, and accessibility gates. The bounded keyboard-driven construction, production, Future Well, victory, result, and post-result restart path is accepted at version 0.50.0.
