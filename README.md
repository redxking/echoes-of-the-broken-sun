...
**Current state:** This is a verified Unreal playable-systems prototype moving into its Glass Scar vertical slice, not a completed game. Version 0.32.0 gives every named Meridian Compact and Kharuun Assemblies slice unit and structure a distinct deterministic entity category, authored statistics, cost, logistics/production behavior, schema-11 save/replay identity, faction-specific display name, placeholder silhouette, and direct build/production control. The 31-entity playable scenario contains both complete rosters, while the 400-unit fixture mixes line, heavy, and scout combatants across four teams. Rules version 1 and canonical content SHA-256 `46bc07c2f792417f880c988b053c2ac825013b695787b0e49da95ebddf92e949` are embedded in snapshots, replays, player views, AI decisions, and checksums. The deterministic core passes 19/19 suites in optimized, debug, and sanitizer configurations; the arm64 Development Editor builds; Unreal automation passes 13/13 without warnings or errors; and both runtime gates load all 16 roster archetypes. The roster is mechanically distinct at the baseline-stat/production level, but deployment, cover, supply extension, mobile rooting, adaptation, and vibration detection remain unimplemented. Campaign, multiplayer, and replay UI remain hidden. Presentation is unchanged from the bounded 0.27.0 Metal inspection. The latest accepted package remains clean-source 0.23.1 at commit `98a9b83`; version 0.32.0 has not been packaged or profiled. Final effects, formations, complete pointer interaction, a rendered end-to-end player-driven match, networked multiplayer, clean-machine use, Developer ID signing, notarization, final art/audio, complete accessibility/settings implementation, and release qualification remain open.
