...
{
    (void)Parameters;
    TestEqual(TEXT("Research interruption uses snapshot schema 21"),
              echoes::sim::kSnapshotVersion, 21U);
    TestEqual(TEXT("Research interruption uses replay schema 21"),
              echoes::sim::kReplayVersion, 21U);
