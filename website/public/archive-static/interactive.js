...
(function () {
  ...
  const WorldGalleryItems = [
    ...
    { id: 'gs-overview', title: 'Glass Scar — Engine Overview', desc: 'Full battlefield overview showing the vitrified chasm, Matter deposits, and three diverging route options in the current Unreal Engine build.', img: 'assets/engine/glass-scar-overview-in-engine.webp', conceptImg: 'assets/concepts/target-render-vertical-slice.webp', register: 'ENGINE-WIP', badge: 'Engine capture · UI hidden', hasCompare: true },
    { id: 'gs-ashcut', title: 'Ash Cut Route — Engine', desc: 'The aggressive flanking route through volcanic ash flats. Fast traversal, minimal cover, high risk.', img: 'assets/engine/glass-scar-ash-cut-in-engine.webp', register: 'ENGINE-WIP', badge: 'Engine capture · UI hidden' },
    { id: 'gs-causeway', title: 'Buried Causeway — Engine', desc: 'A subterranean passage beneath the scar. Protected from artillery but vulnerable to ambush at chokepoints.', img: 'assets/engine/glass-scar-buried-causeway-in-engine.webp', register: 'ENGINE-WIP', badge: 'Engine capture · UI hidden' },
    { id: 'gs-verge', title: 'Folded Verge — Engine', desc: 'The defended high-ground route along the scar edge. Slow advance with excellent firing positions.', img: 'assets/engine/glass-scar-folded-verge-in-engine.webp', register: 'ENGINE-WIP', badge: 'Engine capture · UI hidden' }
  ];
