...
if ! rg -q '\[ECHOES_ART_COMPLETE\] generated=16' "$log"; then
  print -u2 "The Unreal art generator did not report all 16 assets."
...
print "Generated 16 Echoes static meshes plus the shared surface material."
