...
if [[ "$(read_report_value succeeded)" != "36" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 36/36 clean result."
...
print "Unreal automation passed: 36/36 Echoes tests, 0 warnings, 0 errors."
