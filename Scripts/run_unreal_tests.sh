...
if [[ "$(read_report_value succeeded)" != "61" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 61/61 clean result."
...
print "Unreal automation passed: 61/61 Echoes tests, 0 warnings, 0 errors."
