...
if [[ "$(read_report_value succeeded)" != "30" ||
  ...
  print -u2 "Unreal automation totals did not match the accepted 30/30 clean result."
...
print "Unreal automation passed: 30/30 Echoes tests, 0 warnings, 0 errors."
