...
if [[ "$(read_report_value succeeded)" != "53" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 53/53 clean result."
...
print "Unreal automation passed: 53/53 Echoes tests, 0 warnings, 0 errors."
