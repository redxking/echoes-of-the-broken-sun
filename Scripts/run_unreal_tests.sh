...
if [[ "$(read_report_value succeeded)" != "50" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 50/50 clean result."
...
print "Unreal automation passed: 50/50 Echoes tests, 0 warnings, 0 errors."
