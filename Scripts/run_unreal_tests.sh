...
if [[ "$(read_report_value succeeded)" != "52" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 52/52 clean result."
...
print "Unreal automation passed: 52/52 Echoes tests, 0 warnings, 0 errors."
