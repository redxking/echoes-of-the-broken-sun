...
if [[ "$(read_report_value succeeded)" != "54" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 54/54 clean result."
...
print "Unreal automation passed: 54/54 Echoes tests, 0 warnings, 0 errors."
