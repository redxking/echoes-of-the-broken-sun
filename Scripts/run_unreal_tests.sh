...
if [[ "$(read_report_value succeeded)" != "57" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 57/57 clean result."
...
print "Unreal automation passed: 57/57 Echoes tests, 0 warnings, 0 errors."
