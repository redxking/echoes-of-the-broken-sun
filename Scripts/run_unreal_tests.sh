...
if [[ "$(read_report_value succeeded)" != "49" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 49/49 clean result."
...
print "Unreal automation passed: 49/49 Echoes tests, 0 warnings, 0 errors."
