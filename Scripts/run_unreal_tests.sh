...
if [[ "$(read_report_value succeeded)" != "37" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 37/37 clean result."
...
print "Unreal automation passed: 37/37 Echoes tests, 0 warnings, 0 errors."
