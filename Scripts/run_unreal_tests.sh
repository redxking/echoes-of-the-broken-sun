...
if [[ "$(read_report_value succeeded)" != "3" ||
  ...
  print -u2 "Unreal automation totals did not match the accepted 3/3 clean result."
...
print "Unreal automation passed: 3/3 Echoes tests, 0 warnings, 0 errors."
