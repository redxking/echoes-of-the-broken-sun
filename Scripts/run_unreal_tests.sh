...
if [[ "$(read_report_value succeeded)" != "5" ||
  ...
  print -u2 "Unreal automation totals did not match the accepted 5/5 clean result."
...
print "Unreal automation passed: 5/5 Echoes tests, 0 warnings, 0 errors."
