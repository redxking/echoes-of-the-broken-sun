...
if [[ "$(read_report_value succeeded)" != "10" ||
  ...
  print -u2 "Unreal automation totals did not match the accepted 10/10 clean result."
...
print "Unreal automation passed: 10/10 Echoes tests, 0 warnings, 0 errors."
