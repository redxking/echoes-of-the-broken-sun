...
if [[ "$(read_report_value succeeded)" != "33" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 33/33 clean result."
...
print "Unreal automation passed: 33/33 Echoes tests, 0 warnings, 0 errors."
