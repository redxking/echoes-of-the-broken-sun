...
if [[ "$(read_report_value succeeded)" != "46" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 46/46 clean result."
...
print "Unreal automation passed: 46/46 Echoes tests, 0 warnings, 0 errors."
