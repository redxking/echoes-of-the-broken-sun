...
if [[ "$(read_report_value succeeded)" != "45" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 45/45 clean result."
...
print "Unreal automation passed: 45/45 Echoes tests, 0 warnings, 0 errors."
