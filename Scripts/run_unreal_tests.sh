...
if [[ "$(read_report_value succeeded)" != "56" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 56/56 clean result."
...
print "Unreal automation passed: 56/56 Echoes tests, 0 warnings, 0 errors."
