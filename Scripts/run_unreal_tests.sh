...
if [[ "$(read_report_value succeeded)" != "44" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 44/44 clean result."
...
print "Unreal automation passed: 44/44 Echoes tests, 0 warnings, 0 errors."
