...
if [[ "$(read_report_value succeeded)" != "2" ||
  ...
  print -u2 "Unreal automation totals did not match the accepted 2/2 clean result."
...
print "Unreal automation passed: 2/2 Echoes tests, 0 warnings, 0 errors."
