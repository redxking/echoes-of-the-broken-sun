...
if [[ "$(read_report_value succeeded)" != "38" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 38/38 clean result."
...
print "Unreal automation passed: 38/38 Echoes tests, 0 warnings, 0 errors."
