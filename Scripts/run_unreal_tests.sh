...
if [[ "$(read_report_value succeeded)" != "40" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 40/40 clean result."
...
print "Unreal automation passed: 40/40 Echoes tests, 0 warnings, 0 errors."
