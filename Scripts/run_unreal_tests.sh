...
if [[ "$(read_report_value succeeded)" != "70" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 70/70 clean result."
...
print "Unreal automation passed: 70/70 Echoes tests, 0 warnings, 0 errors."
