...
if [[ "$(read_report_value succeeded)" != "39" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 39/39 clean result."
...
print "Unreal automation passed: 39/39 Echoes tests, 0 warnings, 0 errors."
