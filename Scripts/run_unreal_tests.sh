...
if [[ "$(read_report_value succeeded)" != "55" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 55/55 clean result."
...
print "Unreal automation passed: 55/55 Echoes tests, 0 warnings, 0 errors."
