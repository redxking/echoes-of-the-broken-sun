...
if [[ "$(read_report_value succeeded)" != "51" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 51/51 clean result."
...
print "Unreal automation passed: 51/51 Echoes tests, 0 warnings, 0 errors."
