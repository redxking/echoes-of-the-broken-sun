...
if [[ "$(read_report_value succeeded)" != "29" ||
  ...
  print -u2 "Unreal automation totals did not match the accepted 29/29 clean result."
...
print "Unreal automation passed: 29/29 Echoes tests, 0 warnings, 0 errors."
