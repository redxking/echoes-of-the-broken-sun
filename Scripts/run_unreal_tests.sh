...
if [[ "$(read_report_value succeeded)" != "43" ||
  ...
  print -u2 "Unreal automation totals did not match the expected 43/43 clean result."
...
print "Unreal automation passed: 43/43 Echoes tests, 0 warnings, 0 errors."
