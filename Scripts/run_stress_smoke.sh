...
if ! /usr/bin/grep -q \
  '\[ECHOES_CONTENT_READY\] packVersion=1 schema=2 factions=3 playable=3 units=12 buildings=12 technologies=6 sha256=0460f5e2fc180238fc71364af138cce3fe1943ef2942af19a66eb2cc1de356e1 source=canonical' \
  "$log"; then
