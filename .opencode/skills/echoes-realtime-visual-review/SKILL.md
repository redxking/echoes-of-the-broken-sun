...
Before any live visual session, read [echoes-heavy-run-coordination](../echoes-heavy-run-coordination/SKILL.md), confirm an exclusive resource reservation, and record and release the reservation. Do not operate under a stale or unconfirmed reservation. Use `echoes-package-provenance`, `echoes-performance-profiling`, and `echoes-evidence-gate-review` for the corresponding separate claims.
