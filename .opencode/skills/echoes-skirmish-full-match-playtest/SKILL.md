...
Read `../WorkstreamControl/HEAVY_RUN_LOCK.md` before launch, acquire a current detailed lease, and explicitly release it after the match. Stop for missing/currently held/unrelated lease. Package provenance is `echoes-package-provenance`; interpret evidence through `echoes-evidence-gate-review`; human closure is separate.
