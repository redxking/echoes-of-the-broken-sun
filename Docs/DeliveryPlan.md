...
| Saved baseline | `main` = `origin/main` after the fourth-slice commits (code `9adc348`: Adaptive opening posture bounds its attack reach; docs commit following it). Earlier today: `d2992b7`/`68653ab`, `a37bacd`/`c924e72`, `ec1cca5`/`951433d`. |
