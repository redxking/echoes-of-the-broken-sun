...
| Saved baseline | `main` = `origin/main` = `840f8c3`, pushed 2026-09-12 under the owner's granted push authority (`14dc8ca..840f8c3`, 20 commits). The tip is a record correction; the last code commit `21ee8e7` (re-sign the projected snapshot buffer) is the one the combined suite verified. Earlier baselines: `a8607f8` (schema 31 movement fix), `af611e6`/`afe96c6`/`899f55a` (D2 exit review), `9adc348`, `2cb36a9`, `d2992b7`/`68653ab`, `a37bacd`/`c924e72`, `ec1cca5`/`951433d`. |
