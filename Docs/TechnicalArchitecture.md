...
The present code-only interface implements and persists HUD scale, high-contrast HUD, reduced motion, reduced flashing, edge pan, pan-speed scale, and zoom-step scale. Interactive launch presents a feature-gated title state with the Glass Scar skirmish and eight campaign missions through **The Shape Beside Us**; F9 rebuilds the selected operation at tick zero, while Tab changes faction only for skirmish. Enter advances through an operation-specific brief and deployment. The authoritative tick remains paused and battlefield/camera commands blocked until deployment. Unattended and profiled runs may explicitly bypass those states. Escape or P opens the existing modal field menu; R rebuilds the selected operation. The local objective snapshot retains the fair skirmish Core/visible-Well/visible-hostile/public-outcome fields and adds operation-specific campaign phase, protected-entity state, local-Core survival, prior-ledger consumption, and the locally authored Well consequence. The HUD converts those facts into operation-specific trackers without advancing the mission. Skirmish terminal state presents victory/draw/defeat; campaign missions present success/failure only after their subsystem reducers determine the outcome. The tactical overview remains fog-respecting for entities/terrain and adds only authored public sites for the selected operation. Version 0.65.0 includes the Kharuun Waystone, Listening Spine, two distinct memory witnesses, and Oruun confluence markers for Mission 07; its result boundary records observed correspondence only and does not establish cause, hidden authorship, or a Choir identity. Version 0.85.0 adds Mission 08 first-echo, relay, paired-state, and Neme-convergence markers, preserving a reciprocal-contact-only boundary. These are prototype boundaries; a production UMG/CommonUI shell, broad skirmish setup, complete settings/remapping, and a general campaign presentation/store have not been built.
...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, eight bounded campaign missions, and a runtime Unreal view/controller adapter. Version 0.85.0 at exact clean game-source commit `2a9d06e6ba887f48f18d4dd57665086b8ca5de07` retains the protocol-2 remote-order, complete-match, six-case delivery, bounded reconnect, reliable completion-confirmation, and NetDriver packet-profile work and adds **The Shape Beside Us**. Content passed 27/27; native simulation/protocol coverage passed 28/28 in optimized, debug, and sanitizer configurations; the arm64 Development Editor built; and 38/38 Unreal automation tests passed without warning or error. A seven-record Preserve bootstrap passed, and a 1319x768 Metal review accepted the title, briefing, live objective/minimap layout, and high-contrast presentation without observed clipping or overlap. Mission 08 establishes repeatable, actionable reciprocal contact only; it does not establish a unified Choir identity, hidden authorship, causation, or a playable Hollow Choir faction. The NetDriver evidence remains non-shipping localhost packet simulation, not macOS traffic shaping, measured WAN behavior, or separate-machine play. The reconnect fixture remains a Development bearer path, not authentication, protected credential storage, encryption, hostile-traffic or abuse resistance, private invitations, spectators, or security qualification. Physical-human pointer usability, arbitrary or dynamically resized layouts, alternate complete Mission 08 routes, broad simultaneous-combat readability, final art/audio, current package performance, named or multiple campaign slots, the remaining campaign, complete multiplayer, and game completion remain open. Version 0.85.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
