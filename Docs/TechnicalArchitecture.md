...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, seven bounded campaign missions, and a runtime Unreal view/controller adapter. Version 0.83.0 at exact clean game-source commit `4f2cf6958f8c59b2e174c504940bef82d9151b73` retains the protocol-2 remote-order, complete-match, and six-case delivery work and adds bounded seat reservation plus exact scoped reconnect resynchronization. One phase-one client admitted batch 1/sequence 1 and disconnected; an invalid replacement was rejected without consuming the reservation; and a later fresh process resumed the running authority at batch 2/sequence 1, admitted sequence 2, observed execution, and acknowledged a fresh scoped lineage. The final server log contained no credential values. The six independent delivery pairs, complete controlled 24-actor match, 27/27 content tests, 28/28 native suites in optimized, debug, and sanitizer configurations, arm64 Development Editor build, 37/37 Unreal automation tests without warning or error, and normal Meridian bootstrap also passed. The reconnect fixture is a localhost Development bearer path, not authentication, protected credential storage, encryption, separate-machine play, operating-system traffic behavior, hostile-traffic or abuse resistance, private invitations, spectators, or security qualification. The 0.81 rendered battlefield review and all earlier campaign, art, audio, responsive-HUD, and pointer evidence remain accepted only at their recorded limits. Physical-human pointer usability, arbitrary or dynamically resized layouts, broad simultaneous-combat readability, final art/audio, current package performance, named or multiple campaign slots, the remaining campaign, complete multiplayer, and game completion remain open. Version 0.83.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
