...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, ten bounded campaign missions, and a runtime Unreal view/controller adapter. Version 0.87.0 at exact clean game-source commit `e55e6da7511c23af778fdfd37d221bf72e7d0bc4` retains the protocol-2 remote-order, complete-match, six-case delivery, bounded reconnect, reliable completion-confirmation, NetDriver packet-profile work, and Missions 01–09, then adds **The Choir at Lume Reach**. Content passed 27/27; native simulation/protocol coverage passed 28/28 in optimized, debug, and sanitizer configurations; the arm64 Development Editor built; and 40/40 Unreal automation tests passed with zero test warnings or errors. Mission 10 automation covers the 27-case branch-plan matrix, one complete Preserve route, tenth-record persistence, exact save-envelope binding, and adversarial Preserve-to-Harvest primary/backup rejection. A nine-record Preserve startup smoke passed. A requested 1600x900 Metal review produced an observed 1319x768 app frame. Earlier review frames exposed one clipped briefing line and one overlong deployed status line; both were shortened, rebuilt, and retested. The final title, claim-bounded briefing, live objective/minimap layout, high-contrast view, and restored-default view showed no observed clipping or overlap, and Unreal exited normally. The Metal log retains nonblocking editor widget-registration warnings and a generated world-material instancing-usage fallback warning, so the visual result is not final-material qualification. Mission 10 establishes one complete automated Preserve route and bounded plan/reducer coverage for the other branches; it does not establish complete Harvest or Reshape playthroughs, ordinary human completion, literal three-faction command, or a playable Hollow Choir. The NetDriver evidence remains non-shipping localhost packet simulation, not macOS traffic shaping, measured WAN behavior, or separate-machine play. The reconnect fixture remains a Development bearer path, not authentication, protected credential storage, encryption, hostile-traffic or abuse resistance, private invitations, spectators, or security qualification. Physical-human pointer usability, arbitrary or dynamically resized layouts, broad simultaneous-combat readability, final art/audio, current package performance, named or multiple campaign slots, the remaining campaign, complete multiplayer, and game completion remain open. Version 0.87.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
