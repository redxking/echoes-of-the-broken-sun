...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, twelve bounded campaign missions, and a runtime Unreal view/controller adapter. Version 0.89.0 at exact game-source commit `ab3bbdffe8953454025c7c307e47b9e185e5f9a9` retains the accepted networking and Missions 01–11, then adds **The Future That Won** and snapshot/replay schema 21. Content passed 27/27 with canonical SHA-256 `100f1fcd184cf94fe9b21d3f591714a2e33cc92b60f018bc6523868675156fa0`; native simulation/protocol coverage passed 29/29 in optimized, debug, and sanitizer configurations; the arm64 Development Editor built; and 42/42 Unreal automation tests passed with zero test warnings or errors. Mission 12 automation covers all 27 plan contracts, strict eleven-record admission, neutral-interface/Kharuun-only authority, ordered phase gates, controller Preserve initialization, schema-20 migration at the simulation boundary, native schema-21 activation persistence, forged-provenance rejection, exact primary/backup save-envelope binding, one complete Harvest-founding/Life-Support-plus-Transit/Preserve route, twelfth-record persistence, and replay conflict. The automation index SHA-256 is `446c4470dc6fd0fcda28da0b30c6fae8161c4ffa313322fe440bc815f5ed3158`. An eleven-record Preserve startup smoke passed with log SHA-256 `7ee0fabb2dd6c6e1e3ceac351e37b4440671fabd83c9827e3ab6a0137def3a9c`. A requested 1600x900 Metal review produced an observed 1319x768 app frame. The first briefing review exposed three clipped lines; a later deployed/high-contrast review exposed a clipped minimap caption. Both were corrected, rebuilt, retested, and replaced. The final title, briefing, live objective/minimap layout, high-contrast view, and restored-default view showed no observed clipping or overlap, high contrast was restored off, and Unreal exited normally. The Metal log contains no project warning/error, fatal, assertion, or failed-boot marker; it retains 23 nonblocking editor/material warnings, including the generated world-material instancing fallback, so the visual result is not final-material qualification. Mission 12 establishes all 27 plan contracts and one complete automated Preserve route; it does not establish a full Reshape or other alternate playthrough, ordinary human completion, population restoration, civilian counts or survival, permanence, trust, consent, ethical justification, mixed-faction command, a playable Rhyse or Choir, broad balance/usability, or final assets. The NetDriver evidence remains non-shipping localhost packet simulation, not macOS traffic shaping, measured WAN behavior, or separate-machine play. The reconnect fixture remains a Development bearer path, not authentication, protected credential storage, encryption, hostile-traffic or abuse resistance, private invitations, spectators, or security qualification. Physical-human pointer usability, arbitrary or dynamically resized layouts, broad simultaneous-combat readability, final art/audio, current package performance, named or multiple campaign slots, Missions 13–15, complete multiplayer, and game completion remain open. Version 0.89.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
