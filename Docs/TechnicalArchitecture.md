...
As recorded on 2026-08-29, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, and a runtime Unreal view/controller adapter. Version 0.50.0 retains schema-20 research, deterministic Tab/Backspace selection, anonymous-contact presentation, and the discoverable Kharuun aliases while adding complete combat-force selection, selected-group centroid snap, and the bounded Adaptive opening posture. Source commit `cf00559e7431288a4dbbd23073afa24f07976309` passes 27/27 compiler tests, 27/27 native suites in each of three configurations, an arm64 Development Editor build, 22/22 Unreal automation tests without warning or error, both normal faction runtimes, the controlled Kharuun systems fixture, and the 400-unit/four-team active-combat gate. Ordinary rendered application input accepts movement, attack-move, a Meridian Bulwark deploy/pack/redeploy cycle, completed Array Foundry construction, produced-unit emergence, completed two-tier research for both playable factions, completed Kharuun Carapace adaptation, Cairnback mineral cover, Future Well Harvest, five-unit Hold, control-group assignment/recall, five-route Patrol, nine-unit force assembly, Command-Core victory, result presentation, and Enter-driven deterministic redeployment. Exact coordinate-pointer delivery and ordinary player-driven research interruption remain unaccepted. Broad tactical-group usability, balance, a fully authored vertical slice, networked multiplayer, and game completion also remain open. Version 0.50.0 has not been packaged or profiled because free storage is below the packaging floor; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as test evidence changes.
