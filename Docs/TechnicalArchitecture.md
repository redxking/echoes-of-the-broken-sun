...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, nine bounded campaign missions, and a runtime Unreal view/controller adapter. Version 0.86.0 at exact clean game-source commit `83137bfb64cabadc9a080320488cd0e4417f0f3d` retains the protocol-2 remote-order, complete-match, six-case delivery, bounded reconnect, reliable completion-confirmation, NetDriver packet-profile work, and Missions 01–08, then adds **Reserve Authority**. Content passed 27/27; native simulation/protocol coverage passed 28/28 in optimized, debug, and sanitizer configurations; the arm64 Development Editor built; and 39/39 Unreal automation tests passed without warning or error. An eight-record Preserve startup smoke passed. A requested 1600x900 Metal review produced an observed 1319x768 frame; after one overlong minimap caption was found, shortened, rebuilt, and retested, the accepted title, briefing, live objective/minimap layout, high-contrast view, and restored-default view showed no observed clipping or overlap. Mission 09 establishes one repeatable local exact-two district allocation only; it does not establish wider-city restoration, civilian-survival evidence, ordinary human completion, or alternate complete routes. The NetDriver evidence remains non-shipping localhost packet simulation, not macOS traffic shaping, measured WAN behavior, or separate-machine play. The reconnect fixture remains a Development bearer path, not authentication, protected credential storage, encryption, hostile-traffic or abuse resistance, private invitations, spectators, or security qualification. Physical-human pointer usability, arbitrary or dynamically resized layouts, broad simultaneous-combat readability, final art/audio, current package performance, named or multiple campaign slots, the remaining campaign, complete multiplayer, and game completion remain open. Version 0.86.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
