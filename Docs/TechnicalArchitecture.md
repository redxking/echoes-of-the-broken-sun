...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, seven bounded campaign missions, and a runtime Unreal view/controller adapter. Version 0.84.0 at exact clean game-source commit `95f34c92bff5dc55660e7466a71b8e9c0d402572` retains the protocol-2 remote-order, complete-match, six-case delivery, and bounded reconnect work and adds a reliable completion-confirmation round trip plus Unreal NetDriver latency/jitter and loss profiles. Both packet profiles passed; one loss trial observed missing-base rejection, full-keyframe recovery, exact acknowledgement retirement, execution, and authority-confirmed completion. The six independent delivery pairs, complete controlled 24-actor match, reconnect lifecycle, 27/27 content tests, 28/28 native suites in optimized, debug, and sanitizer configurations, arm64 Development Editor build, 37/37 Unreal automation tests without warning or error, and normal Meridian bootstrap also passed. The NetDriver evidence is non-shipping localhost packet simulation, not macOS traffic shaping, measured WAN behavior, or separate-machine play. The reconnect fixture remains a Development bearer path, not authentication, protected credential storage, encryption, hostile-traffic or abuse resistance, private invitations, spectators, or security qualification. The 0.81 rendered battlefield review and all earlier campaign, art, audio, responsive-HUD, and pointer evidence remain accepted only at their recorded limits. Physical-human pointer usability, arbitrary or dynamically resized layouts, broad simultaneous-combat readability, final art/audio, current package performance, named or multiple campaign slots, the remaining campaign, complete multiplayer, and game completion remain open. Version 0.84.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
