...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, seven bounded campaign missions, and a runtime Unreal view/controller adapter. Current version 0.76.0 at exact game-source commit `6412831de07b0d6fbaca0341e356bf64bd5b6f03` retains **The Shape of Silence**, prior-generation campaign restoration, deterministic research cancellation, all three accepted production-oriented Glass Scar route kits, registered presentation audio, destruction feedback, and authored selection/command VFX while strengthening responsive HUD and pointer combat/Guard qualification to complete actor bounds in seven fixed Metal configurations. The exact source passes 27/27 compiler tests, 27/27 native suites in optimized, debug, and AddressSanitizer/UndefinedBehaviorSanitizer configurations, an arm64 Development Editor build, 36/36 Unreal automation tests without warning or error, a normal Meridian null-RHI bootstrap, four 1,600 × 900 camera/HUD reviews, compact 1,280 × 720, Mac 16:10 1,440 × 900, and Full HD 1,920 × 1,080. Each review matched its exact viewport, kept all three complete projected actor boxes clear of visible HUD geometry and the viewport margin, exercised ordinary LMB selection, `J` Guard, and RMB direct Attack, and observed authoritative Guard state and damage. Earlier exact-source evidence retains its recorded boundaries. Physical-human pointer usability, arbitrary or dynamically resized resolution/aspect-ratio/camera coverage, broad simultaneous-combat/camera/audio readability, subjective listening and final mix/master quality, music, voice, ambience, complete alerts, final Niagara debris/smoke, transparency/dissolve, production textures and surface response, current package performance, named or multiple campaign slots, arbitrary campaign history, the remaining campaign, networked multiplayer, and game completion remain open. Version 0.76.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
