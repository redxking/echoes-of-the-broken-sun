...
The present code-only interface implements and persists HUD scale, high-contrast HUD, reduced motion, reduced flashing, edge pan, pan-speed scale, and zoom-step scale. Interactive launch presents a feature-gated title state with the Glass Scar skirmish and fourteen campaign missions through **Several Voices, One Command**; F9 rebuilds the selected operation at tick zero, while Tab changes among supported factions only for skirmish. Enter advances through an operation-specific brief and deployment. The authoritative tick remains paused and battlefield/camera commands blocked until deployment. Unattended and profiled runs may explicitly bypass those states. Escape or P opens the existing modal field menu; R rebuilds the selected operation. The local objective snapshot retains the fair skirmish Core/visible-Well/visible-hostile/public-outcome fields and adds operation-specific campaign phase, protected-entity state, local-Core survival, prior-ledger consumption, and the locally authored consequence. The HUD converts those facts into operation-specific trackers without advancing the mission. Skirmish terminal state presents victory/draw/defeat; campaign missions present success/failure only after their subsystem reducers determine the outcome. The tactical overview remains fog-respecting for entities/terrain and adds only authored sites for the selected operation. Versions 0.65.0 through 0.90.0 retain the previously accepted bounded public markers and claim language. Version 0.91.0 adds Mission 14's Possible and Manifest voice sites, Neme command site, inherited crisis site, visible research/identity/coherence state, Phase Anchor construction and 160-tick hold tracker. The shortened live legend was accepted only after the longer clipped candidate was rejected. The title, brief, tracker, result, and logs identify local Hollow Choir authority while limiting success to one held crisis; they do not claim a final Choir fate, permanent unified identity, broad faction balance, or campaign completion. These are prototype boundaries; a production UMG/CommonUI shell, broad skirmish setup, complete settings/remapping, and a general campaign presentation/store have not been built.
...
As recorded on 2026-08-30, version 0.91.0 at exact game-source commit `5fd15a4034f8502d65a4dc2634e545eb9ff65fc6` retains the accepted networking and Missions 01–13, adds complete source definitions and bounded deterministic systems for the Hollow Choir's twelve total cross-faction units, twelve structures, and six technologies, exposes the Choir as a local skirmish selection, advances native snapshot/replay schema to 22, and implements the fourteenth campaign mission, **Several Voices, One Command**. Content passed 34/34 with canonical SHA-256 `0460f5e2fc180238fc71364af138cce3fe1943ef2942af19a66eb2cc1de356e1`; native simulation/protocol coverage passed 32/32 in optimized, debug, and sanitizer configurations; the arm64 Development Editor built; and 44/44 Unreal automation tests passed with zero test warnings or errors. Mission 14 automation covers all 27 plan contracts, strict thirteen-record admission, Hollow Choir-only authority, phase-gated Held Alternatives and Shared Resolution, Possible/Manifest voice reconciliation and separate sites, Neme's command site, ordinary Phase Anchor construction, the exact 160-fixed-tick crisis hold, per-fixed-step irreversible breach detection, native schema-22 persistence, complete-envelope CRC integrity, one-bit latch tamper rejection with backup-only recovery, one complete Harvest-founding/Life-Support-plus-Transit/Preserve route, record-14 persistence, idempotent replay, and divergent replay refusal. Full-index/focused/startup-smoke SHA-256 values are `2bf68ca30d81e3d76ededca77f2103a77d44f50f23cbf4763d34c0d59055ef61`, `9f7411c2fe1f21efa91dc0d78c41a689ad91880974ca91e5f74d05e8689b8015`, and `4830a6201cbed296a1510a84764d09645c56868de4467ecc976f001dc25e74b2`. A requested 1600x900 Metal review produced an observed 1319x768 app frame under project version 0.91.0. The initial long live legend was rejected for clipping; the shortened title, briefing, live objective/minimap, high-contrast, and restored-default true-PNG frames showed no observed clipping or overlap. High contrast was restored off and Unreal exited normally. Metal-log/title/briefing/live/high-contrast/restored SHA-256 values are `03a954ea848a50da4b22337a9c22611a89116c83ac841c8c6045dc3868606f69`, `13d2455bd70e3aee386ee59da3ddd45dbc947d5b91c72015de38a5c3ef92b9c0`, `323a1757f76771c81362fe97dfc794b5c6a4665f5e24fb2ae302b631f3effee8`, `7a65e50d35441abba79cd58d5cc10fc8fbb58b82cc0237aa99d240ab0767cbc7`, `cc6631687cc162f2ee02ea36f5bfe74f0b29511ee800aed0133afc1b02384778`, and `ad2f7e1caf95a4edf24e3e2906349368f378a615e65b5a21f4431c21799ea601`. The log contains no project warning/error, fatal, assertion, or failed-boot marker; it retains 23 nonblocking editor/material warnings, so this is not final-material qualification. Mission 14 establishes one bounded playable Choir command-crisis perspective, not the Choir's final fate, alternate complete routes, ordinary human completion, broad three-faction balance/usability, final assets, current package performance, Mission 15, complete multiplayer, or game completion. Version 0.91.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
