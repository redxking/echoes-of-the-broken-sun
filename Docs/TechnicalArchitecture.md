...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, seven bounded campaign missions, and a runtime Unreal view/controller adapter. Version 0.81.0 at exact clean game-source commit `9e09d7e7d1c960eaa7bf4cda8e65b935df51421d` adds protocol-2 multi-actor intent batches, scoped remote selection/order adapters, authority-owned sequences and timing, and an exact reliable final-state/result transition while retaining the accepted lobby, scoped deltas, recovery, campaign, art, audio, responsive-HUD, and pointer evidence at their recorded limits. The exact source passes 27/27 content tests, 28/28 native suites in optimized, debug, and AddressSanitizer/UndefinedBehaviorSanitizer configurations, an arm64 Development Editor build, 37/37 Unreal automation tests without warning or error, a normal Meridian null-RHI bootstrap, normal and deliberately fault-injected localhost transport smokes, and one complete controlled separate-process match. That match selected 24 remote actors, admitted 24/24 direct-Attack intents, resolved ordinary combat to `Player1Victory` at tick 92, accepted exact final snapshot 11 and its scoped digest, presented victory for seat 1, acknowledged the final state, and exited both processes normally. A 1,440 × 900 Metal battlefield frame with enabled online controls was inspected without observed clipping or overlap. This does not establish unaided-human online usability, every remote adapter, authentication, encryption, reconnect, spectators, separate-machine play, arbitrary latency/reordering/duplication/burst loss, hostile-traffic or abuse resistance, private invitations, or security qualification. Physical-human pointer usability, arbitrary or dynamically resized resolution/aspect-ratio/camera coverage, broad simultaneous-combat/camera/audio readability, final mix quality, music, voice, ambience, complete alerts, final effects, production textures, current package performance, named or multiple campaign slots, arbitrary campaign history, the remaining campaign, complete multiplayer, and game completion remain open. Version 0.81.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
