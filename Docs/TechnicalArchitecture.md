...
As recorded on 2026-08-30, version 0.93.0 retains the accepted networking, three source-reachable local skirmish factions, native snapshot/replay schema 22, campaign schema 2, and all fifteen bounded operations through **The Broken Sun**, then adds a campaign-journey controller around the durable ledger. The resolver admits only an ordered, duplicate-free prefix of the fifteen authored records; `C` opens its exact next operation, failure remains on the current operation, and a complete ledger returns to the title/archive boundary without synthesizing Mission 16. New Campaign and Restore coordinate scenario reconstruction with transactional active/prior ledger generations. Replay conflict pauses the replay scenario and returns to the journey without changing the ledger. Mission 02–09 campaign checkpoint containers bind operation, faction, and the exact prerequisite-ledger projection; unbound raw and version-1 bound campaign saves reject fail closed, while a compatible legacy noncampaign raw save remains loadable and is preserved during first container upgrade. A local 0.93 Unreal report records 46/46 successful tests, zero failed/not-run tests, and no warning or error entries; report SHA-256 is `0acf032afe25c5381980a36737c55a5e0c37ff063b887d7dcfb332ad7f0a55a5`. A one-record Metal title inspection exposes `C: CONTINUE CAMPAIGN`; its log/title SHA-256 values are `4ffb5a16e82626e7cba554c6c6a7abb62cbb2492186a8fe40948465bfe809c46` and `de48532c9f3491a979534b3a56b759f68b1e4493fa5df10a8332c446872ab231`. Those report and render artifacts identify version 0.93.0 but do not embed a Git SHA. Exact package provenance is separate: the retained Mac-arm64 Development package manifest binds clean source commit `79d0cf3b45b7eeebed6d59a3939dae5ef0056421`, version 0.93.0, UE 5.8.2, and Xcode 26.6 build 17F113; manifest/sidecar-file SHA-256 values are `de54024cd33fce495bc86fbadfbfbaa60808956dfa8f6372a6a9f3f151bd8540` and `83a817a2cc0236a5c6c99d048b12fe19174fd85fb6bc010d5507900471be413b`. Normal and 400-unit/four-team packaged null-RHI startup passed on this host. Recovery testing covers controlled single-process/API-level rename failures only, not multiprocess exclusion or power-loss durability. The package is ad-hoc signed, not notarized, and has no current profile, sustained soak, clean-machine result, installer, or release qualification. Version 0.93 establishes journey/controller and checkpoint-binding behavior, not ordinary human full-campaign completion, complete alternate routes/endings, cinematic endings, modeled downstream social consequences, broad three-faction balance/usability, final assets/audio, complete multiplayer, or game completion. The Project Ledger remains authoritative as evidence changes.
