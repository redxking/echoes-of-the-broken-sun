...
As recorded on 2026-08-30, the repository contains a UE 5.8 project, Mac configuration, source JSON for both complete named slice-roster definitions and four faction technologies, a strict canonical content compiler, an immutable digest-verified Unreal catalog, versioned deterministic rules, design records, a tested four-player-capable engine-independent simulation, eleven bounded campaign missions, and a runtime Unreal view/controller adapter. Version 0.88.0 at exact clean game-source commit `e261bd138149159221e5c00ba740eb8e28c0ab35` retains the accepted networking and Missions 01–10, then adds **No Neutral Ledger**. Content passed 27/27 with canonical SHA-256 `100f1fcd184cf94fe9b21d3f591714a2e33cc92b60f018bc6523868675156fa0`; native simulation/protocol coverage passed 28/28 in optimized, debug, and sanitizer configurations; the arm64 Development Editor built; and 41/41 Unreal automation tests passed with zero test warnings or errors. Mission 11 automation covers all 27 plan contracts, admission/rejection, neutral-interface authority and canonical persistence, ordered phase gates, one complete Harvest-founding/Life-Support-plus-Transit/Preserve route, eleventh-record persistence, exact save-envelope binding, and adversarial cross-ledger rejection. The automation index SHA-256 is `d4a2efd2333a2b1a89b47b2e0b68b3f4b0eac052a571548f4edb824110b922e0`. A ten-record Preserve startup smoke passed; its log SHA-256 is `050b337a321917bc329a368466420e2b8033261dbfe882b395b83c63eb6b2aa0`. A requested 1600x900 Metal review produced an observed 1319x768 app frame. The first briefing review exposed wording that could imply construction at the neutral interfaces; it was corrected to require Kharuun links within three tiles, rebuilt, retested, and replaced. The final title, claim-bounded briefing, live objective/minimap layout, high-contrast view, and restored-default view showed no observed clipping or overlap, high contrast was restored off, and Unreal exited normally. The Metal log retains a generated world-material instancing-usage fallback warning and nonblocking engine diagnostic lines, so the visual result is not final-material qualification. Mission 11 establishes all 27 plan contracts and one complete automated route; it does not establish complete alternate playthroughs, ordinary human completion, mixed-faction command, a playable Choir, hidden trust or survivor composition, broad balance/usability, or final assets. The NetDriver evidence remains non-shipping localhost packet simulation, not macOS traffic shaping, measured WAN behavior, or separate-machine play. The reconnect fixture remains a Development bearer path, not authentication, protected credential storage, encryption, hostile-traffic or abuse resistance, private invitations, spectators, or security qualification. Physical-human pointer usability, arbitrary or dynamically resized layouts, broad simultaneous-combat readability, final art/audio, current package performance, named or multiple campaign slots, Missions 12–15, complete multiplayer, and game completion remain open. Version 0.88.0 has not been packaged or profiled; the latest accepted package remains 0.23.1. The Project Ledger remains authoritative as evidence changes.
