...
- Camera, selection, context-order, construction/production hotkeys, pause/restart, HUD, entity-view, Glass Scar terrain, arena, lighting, and placeholder fog/shroud presentation code exists. Views are scoped to currently visible entities and explored terrain persists in the presentation, but final terrain/fog art and exact-build pointer selection, placement, production, and context orders remain unverified.
