...
| 6 | Every campaign site dressed to its stated identity; no bare collision floor | A4 | 5 | IN PROGRESS — Glass Scar dressing pack consumed at runtime on 2026-09-04 (ledger WORLD-A4-001, evidence `BuildArtifacts/Evidence/release-gate6-glass-scar-dressing-20260903T235243Z`): 29 digest-pinned shelf/shard records drawn only on live-Blocked, explored, non-reshaped cells; per-site vocabularies for Lume Reach, ark-city, Crownfall, and Choir sites remain empty and the ridge class deferred; no bare-collision-floor pass through the missions yet |
...
| 9 | Production fog and shroud within the 1.5 ms budget | A7 | 3 | NOT RUN |
...
| 12 | Full score registered with per-cue loudness and true peak measured; combat crossfade demonstrated | B2 | 2 | NOT RUN |
| 13 | Ambience beds per site, positional where sourced, not masking combat cues | B3 | 2 | NOT RUN |
...
| 31 | Named slots, autosave, and recovery flow tested | E5 | 1 | NOT RUN |
| 32 | Skirmish setup exposes every option with a test per option | F1 | 10 | NOT RUN |
