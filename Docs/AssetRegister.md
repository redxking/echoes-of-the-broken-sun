...
- AI-assisted asset generation, if later authorized, requires the exact service, plan, date, prompt/source inputs, output terms, and human modification record. No such asset is currently approved.
