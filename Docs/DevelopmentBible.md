...
The current 0.36.0 Glass Scar opponent is a bounded standard-difficulty Adaptive implementation. It gathers and scouts, chooses a Future Well protocol by personality, produces workers and line units, adds production and logistics capacity from its redacted player view, attacks currently visible enemies with all combat categories, withdraws low-health combatants toward its own headquarters, and selects a bounded warform adaptation from visible enemy composition when a valid Growth Basin is in range. All eight named units and eight named structures have distinct authoritative categories and baseline authored values. Meridian Bulwark deployment and Relay supply extension retain their public counterplay. Kharuun Waystones expose rooted, transitioning, and mobile state. Kharuun combat warforms can enter an 80-tick stationary molt within 600 cm of a completed Growth Basin for 25 Dawn. The public molt/form geometry is non-color-distinct, exact enemy completion time and health remain redacted, molting takes 150 percent damage, and destroying the Basin or leaving its field cancels the molt without refund. Carapace trades speed for health; Striker improves damage and attack cadence. Direct Kharuun player-side faction selection remains open, so Hyphen and Shift–bracket controls are mapped and validated but are not reachable in the current Meridian-only player scenario. The deterministic AI composition-choice path is tested, but the short normal runtime gate did not observe a live AI molt. Cairnback temporary cover, vibration detection, powered Aegis behavior, broader composition response, coordinated tactical groups, repair/recovery, multiple bases, authored technology paths, and balance qualification remain open.
