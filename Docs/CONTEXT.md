...
**Generated:** 2026-09-11 22:27 UTC by `Scripts/build_context.py`. Do not edit; regenerate.
...
- Branch `main` at `4d5b8b6` (upstream `50dc165`); 359 dirty paths, of which non-asset: `Docs/RequirementsState.md`, `Source/EchoesSimCore/Private/Simulation.cpp`, `Source/EchoesSimCore/Public/EchoesSimCore/Simulation.h`.
