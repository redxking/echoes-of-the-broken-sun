...
|---|---|
| Simulation, movement, combat, economy, AI, save/replay | [TechnicalArchitecture.md](Archive/TechnicalArchitecture.md), applicable source contracts and domain skills. [RTSRegressionArchitecture.md](RTSRegressionArchitecture.md) is a dated 2026-09-05 design deliverable for the regression/test architecture; confirm current implementation in source before relying on it. |
| Campaign, story, character, tutorial | [DevelopmentBible.md](Archive/DevelopmentBible.md), [OpeningAndTutorialScript.md](OpeningAndTutorialScript.md), [CharacterVoiceIdentityBible.md](CharacterVoiceIdentityBible.md), and affected narrative source contracts. [NarrativeCoherenceReview.md](NarrativeCoherenceReview.md) is a dated assessment; verify adoption of its recommendations. [CutsceneAndVideoProductionList.md](CutsceneAndVideoProductionList.md) inventories every cutscene and video with its production brief; proposed staging there is not owner acceptance. |
...
| World, map, terrain, visual composition | [ArtDirection.md](ArtDirection.md), [VisualTargetSpecification.md](VisualTargetSpecification.md), [ComponentDesignCatalog.md](ComponentDesignCatalog.md), [MapConcepts.md](MapConcepts.md), [MapTechnicalBlueprint.md](MapTechnicalBlueprint.md), and affected world source. Map concepts/blueprints are subordinate design references, not a second requirements master. [WorldMapWorkLog.md](WorldMapWorkLog.md) records the current author's bounded work and owner direction; it cannot independently accept requirements. [LightingAtmosphereReview.md](LightingAtmosphereReview.md) is the dated 2026-09-05 M01 lighting pass record; its open items were not re-executed. |
