...
| `REL-SAV-005` | AGENT VERIFIED | EDT | /Volumes/Seagate Game Archive/EchoesOfTheBrokenSun/Project/BuildArtifacts/Evidence/reshape-checkpoint-20260912 | 34906cf | 2026-09-12 | Reshape expiry save-validation defect reproduced and repaired: snapshot33 records exact permanent reopening; real checkpoint save/advance/load restores complete payload/tick/checksum, map/faction and unexplained terrain mismatches refuse. Verified legacy replay reconstructs omitted pre33 history without resetting old rules/prefix; conflicting modern history refuses. Native153 existing+1new pass optimized/debug/sanitizers. Engine140/141 plus last stale test rebuilt and1/1 rerun pass. No packaged/physical/human acceptance. |
...
| `SPEC-WEL-003` | AGENT VERIFIED | SRC | /Volumes/Seagate Game Archive/EchoesOfTheBrokenSun/Project/BuildArtifacts/Evidence/reshape-checkpoint-20260912 | 34906cf | 2026-09-12 | Affected Reshape persistence path verified: reopening history survives exact save/load/replay and normal cover lifecycle; legacy checksum layouts retained and historical history recovered only through verified replay. Authority-only metadata does not enter PlayerView; existing scoped/native/engine tests pass. This scoped result is not human or whole-game acceptance. |
...
- 2026-09-12T13:10Z — `REL-SAV-005` → **AGENT VERIFIED**; class EDT; evidence /Volumes/Seagate Game Archive/EchoesOfTheBrokenSun/Project/BuildArtifacts/Evidence/reshape-checkpoint-20260912; commit 34906cf; Reshape expiry save-validation defect reproduced and repaired: snapshot33 records exact permanent reopening; real checkpoint save/advance/load restores complete payload/tick/checksum, map/faction and unexplained terrain mismatches refuse. Verified legacy replay reconstructs omitted pre33 history without resetting old rules/prefix; conflicting modern history refuses. Native153 existing+1new pass optimized/debug/sanitizers. Engine140/141 plus last stale test rebuilt and1/1 rerun pass. No packaged/physical/human acceptance.
- 2026-09-12T13:10Z — `SPEC-WEL-003` → **AGENT VERIFIED**; class SRC; evidence /Volumes/Seagate Game Archive/EchoesOfTheBrokenSun/Project/BuildArtifacts/Evidence/reshape-checkpoint-20260912; commit 34906cf; Affected Reshape persistence path verified: reopening history survives exact save/load/replay and normal cover lifecycle; legacy checksum layouts retained and historical history recovered only through verified replay. Authority-only metadata does not enter PlayerView; existing scoped/native/engine tests pass. This scoped result is not human or whole-game acceptance.
