...
The observed current 0.36.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; sixteen adversarial content-compiler tests passed; the native core passed 23/23 in optimized, debug, and sanitizer configurations; and seventeen Unreal automation tests passed 17/17 with no test warning or error. Reviewed pack SHA-256 is `4adb4a203a575ec510158baf57f40cc856e52d94609f41b22dd8474938a2e70a`; the digest-sidecar file SHA-256 is `1c1cb92065bc4ef3cab6493c9ebbb3bffde47321c515149f3d0d5f5ce9f68e23`. Stable IDs still map all eight units and all eight structures into sixteen deterministic roster archetypes. Schema-15 state carries Bulwark deployment, Relay supply, Waystone migration, and Growth Basin warform-adaptation profiles plus their public state. A valid molt costs 25 Dawn, requires a completed friendly Basin within 600 cm, takes 80 stationary ticks, and applies 150 percent incoming damage. Site destruction or field departure cancels without refund. Carapace applies 135 percent health and 80 percent movement; Striker applies 125 percent damage and 85 percent attack period. Adaptive AI chooses from visible enemy composition through its redacted view. Shift–bracket mappings and a non-color public state proxy are integration-tested, although direct valid use remains absent from the Meridian-only player scenario. The 32-entity normal fixture and 400-unit/four-team fixture remain green. Clean source commit `5a853884e0f27abe808494aa6727221db88048c2` produced evidence hashes `fc941b9a8700572eed3653d3a494b3e29de032048fa41f1187a037807db0531f` for the automation index, `f44b3fdb859dcbe97ccf53d52f0c3ad53908c0e0fbec88fcaff939899a141250` for normal runtime, and `bc81042f3e1f57225b782f21073ca70daa5a60fc499446a895c6c6c1cd95c985` for stress runtime. The short normal runtime did not observe a live AI molt, so AI adaptation is accepted only at the deterministic test boundary. This establishes four bounded faction mechanics, not complete faction identity, balance, Kharuun player-side usability, a rendered pointer-driven match, final effects/formations, network transport, broader gameplay completeness, or clean-machine installation.
