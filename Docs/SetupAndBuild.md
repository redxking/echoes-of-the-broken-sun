...
The observed current 0.41.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; twenty-seven adversarial content-compiler tests passed; the native core passed 27/27 in optimized, debug, and sanitizer configurations; and twenty-two Unreal automation tests passed 22/22 with no test warning or error. Reviewed pack SHA-256 is `100f1fcd184cf94fe9b21d3f591714a2e33cc92b60f018bc6523868675156fa0`; the digest-sidecar file SHA-256 is `9fa9b2d4effc7131def4266bc6092613272218a933043db59e883ec9a3ceb68d`; snapshot/replay schema is 19. Clean source commit `3e77039534f6c449088d00c543f092614ca74ffc` produced evidence hashes `6332451b745fdfc04f5d5c3ee99007597d01795d096e4ae91d1e38f7df0f680a` for the automation index, `866f48064293bcd3aaffbc92734b8158440e4475e9639dffe2330efbc2362610` for Meridian runtime, `b58953f6cc0fa76e8ac849b2866e2388ced72ec30531cd81835909a10af8c96c` for Kharuun runtime, and `448c9c90b424515d700896077e2dc59aaddd1f045dd62863bc74592a07cd11f3` for stress runtime. Automation exercises canonical technology binding, insufficient-resource feedback, deterministic completion and effects, replay equality, HUD construction, and the `Shift+R` mapping in addition to the prior faction-selection coverage. Both 32-entity faction directions booted under null RHI and observed visibility-scoped AI expansion; stress retained 400 units, four teams, 401 visibility-scoped views, 396 broad orders, and active combat. This establishes source-level faction-research integration and regression, not rendered research interaction, a pointer-driven match, balance, package behavior, network transport, broader gameplay completeness, or clean-machine installation.

## Rendered prototype boundary

The exact 0.23.1 packaged process was identified by its full executable path and visually inspected through Metal at native 2560×1440. Its responsive Glass Scar operations brief was legible without observed clipping, paused deployment, and transitioned to the battlefield and tactical HUD on Enter. The 0.23.0 package had exposed a real defect: its briefing retained a 920-pixel cap and rendered too small on the Retina display. That package is superseded; the proportional 0.23.1 layout is the accepted packaged result. Version 0.40.0 source was inspected at 1600×900 through Metal. The default Meridian title rendered without observed clipping; Tab visibly selected Kharuun and changed the Adaptive opposition to Meridian. Enter opened the Kharuun-specific brief without observed overlap or clipping, and a second Enter deployed to a Kharuun HUD with the Meridian-core objective. Screenshot SHA-256 values are recorded in RENDER-026. A subsequent coordinate-click attempt reproduced the desktop-control failure: the service closed its native pipe before returning, Unreal stayed live, and the HUD remained at zero selected. INPUT-003 therefore remains a tool-integration result, not evidence that human pointer input succeeds or fails. Version 0.41.0 was then launched from clean source through Metal at 1600×900. Its idle `RESEARCH 0/2 complete` line, `Shift+R` producer guidance, resources, controls, objectives, minimap, and deployment feedback rendered without observed clipping or overlap; screenshot SHA-256 `82a86b6c93e2289bc65e5850d59d083cc74229698e0d43e9a32f5e34b5c3bc2e` and visual-log SHA-256 `de31338cff073679fc50211067e69051cd8e4b9be8da9b321d34eca30432a0b3` are recorded in RENDER-027. Active research progress and pointer-driven command use remain unaccepted. Version 0.41.0 has not passed package or packaged-performance gates.
