...
The observed current 0.34.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; twelve adversarial content-compiler tests passed; the native core passed 21/21 in optimized, debug, and sanitizer configurations; and fifteen Unreal automation tests passed 15/15 with no test warning or error. Reviewed pack SHA-256 is `7fac313d5ba8386fe5377c6b8c17d7c2b0608210fbd182e675f7241006e87f32`. Stable IDs still map all eight units and all eight structures into sixteen deterministic roster archetypes. Schema-13 state carries both the authored Meridian Bulwark deployment profile and Relay Skiff supply-extension profile. Bulwark frontal protection remains a non-stacking 40 percent reduction inside its authored footprint, flanking bypasses it, and deployed movement uses 35 percent of base speed. A Relay within 700 cm of an owned completed Anchor or Power Link can add four Logistics for 400 ticks and then enters an 800-tick cooldown; leaving that continuously required connection, severing the last connection, or destroying the Relay collapses the bonus immediately without deleting existing units. Backslash-at-cursor Bulwark control, Equals Relay activation, a world-space barrier, and a public Relay field are integration-tested. The playable fixture remains 31 entities; the 400-unit fixture distributes line, heavy, and scout combatants across four teams while retaining 396 attack-move orders and active combat. Clean source commit `13439b571ba8ec335134df404106601d9da3e931` produced evidence hashes `08f2a1504671da833d10a17eb4bfeaab3ee1b6ad7f571351ed0d1fd3de3de8ac` for the automation index, `b2e975fc56ac4b2e54ffdada1310396a9ce828e02ef1ee4d2e85d4bf7e7a25af` for normal runtime, and `c9a0a1174b2e7ca19abd182ee723cda18d4dbd2f61daf42972e71fd5e7009175` for stress runtime. This establishes two bounded faction mechanics, not complete faction identity, balance, a rendered pointer-driven match, final effects/formations, network transport, broader gameplay completeness, or clean-machine installation.
