...
The next paragraph preserves the complete 0.45.0 matrix as historical evidence; later paragraphs record the focused 0.46.0 through 0.51.0 checkpoints and the current 0.52.0 source/presentation checkpoint.
