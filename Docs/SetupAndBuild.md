...
The observed current 0.37.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; eighteen adversarial content-compiler tests passed; the native core passed 24/24 in optimized, debug, and sanitizer configurations; and eighteen Unreal automation tests passed 18/18 with no test warning or error. Reviewed pack SHA-256 is `7fd659168e66bebf020e7ffb13f0e0bcbb770f5f67ad5dfa22cd5a471bd84ecd`; the digest-sidecar file SHA-256 is `001a2bfd62444e58fb7cb4dfe2e136c3523406d32711babb27b845450839f1a8`. Stable IDs still map all eight units and all eight structures into sixteen deterministic roster archetypes. Schema-16 state carries Bulwark deployment, Relay supply, Waystone migration, Growth Basin warform adaptation, and Cairnback mineral-cover profiles plus their public state. A valid barrier costs 15 Dawn, can be placed within 450 cm, has 180 health and a 75-cm half-extent, lasts 300 ticks, and starts a 600-tick cooldown. It blocks routing, intercepts qualifying fire across its footprint, remains directly destructible, restores the prior open/scarred terrain, and survives its creator. Enemy health, exact expiry, creator identity, and hidden underlying terrain remain redacted. Shift–semicolon mapping and a distinct public barrier proxy are integration-tested, although direct valid use remains absent from the Meridian-only player scenario. The 32-entity normal fixture and 400-unit/four-team fixture remain green. Clean source commit `a27beabe1132a46c6e995b24ac5a329e1de3c715` produced evidence hashes `ab28733537acedf74ee9c379ef6baf674e15ca0bcfae9afc203e82a01b6f6f9c` for the automation index, `0369150de66579d86d0535fa9b647e2434cfea1f2879648179effc40de28ea82` for normal runtime, and `668ff9bb3b26941a1c88b54962e4845a0880991a4d52f4ddb64cdf52cecbacc7` for stress runtime. The short normal runtime observed neither a live AI molt nor mineral-cover placement, so both AI decisions are accepted only at deterministic test boundaries. This establishes five bounded faction mechanics, not complete faction identity, balance, Kharuun player-side usability, a rendered pointer-driven match, final effects/formations, network transport, broader gameplay completeness, or clean-machine installation.

## Rendered prototype boundary

The exact 0.23.1 packaged process was identified by its full executable path and visually inspected through Metal at native 2560×1440. Its responsive Glass Scar operations brief was legible without observed clipping, paused deployment, and transitioned to the battlefield and tactical HUD on Enter. The 0.23.0 package had exposed a real defect: its briefing retained a 920-pixel cap and rendered too small on the Retina display. That package is superseded; the proportional 0.23.1 layout is the accepted packaged result. Version 0.27.0 editor-source inspection at 1600×900 showed the revised title without observed overlap or clipping in normal and high-contrast modes. It exposed only Glass Scar single-player and implemented settings, disclosed the standard Adaptive Kharuun opposition and fair vision/economy boundary, and kept campaign, multiplayer, and replay absent. Enter advanced through the operations brief into deployment, and the live log recorded the first Adaptive expansion on visible valid terrain. The visual log SHA-256 is `a93ec23694ad6a86f7b89758bf2d72b6058f7456f4ef4188106744a927a323d5`. Versions 0.28.0 through 0.31.0 change simulation/AI and authored-content boundaries without changing presentation, so no new visual result is claimed. The current Metal input retry successfully delivered both Enter transitions and then reproduced the desktop computer-control failure: the service closed its native pipe before returning from a coordinate click, Unreal emitted no selection/order marker, the game remained live, and a keyboard quit succeeded after reacquiring the service. The log SHA-256 is `555b74083e186bfc1ae0e056c8ed16e2528c9e658003c77527285d9eed7c9475`. This is a tool-integration result, not evidence that human pointer input succeeds or fails; manual pointer-driven acceptance remains open. Version 0.31.0 has not passed package, packaged-performance, or exact-package visual gates.
