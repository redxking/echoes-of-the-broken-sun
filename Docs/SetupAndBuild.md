...
The observed current 0.38.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; twenty-two adversarial content-compiler tests passed; the native core passed 25/25 in optimized, debug, and sanitizer configurations; and nineteen Unreal automation tests passed 19/19 with no test warning or error. Reviewed pack SHA-256 is `c5f516ab05fcdcb06716b2d6a6786612ba4cb19267ac7fd3bbd4f206efedd1db`; the digest-sidecar file SHA-256 is `ed71575a227edd2e8814913619c69ab5d939cff537d7a40ba795613100abb024`. Schema-17 state carries the prior five faction profiles plus Resonant/Listening Spine vibration detection. Authored ranges are 2,200 and 2,600 cm, signature linger is 40 ticks, and contact resolution is 200 cm. Tests prove actual-movement emission, expiry, coverage loss, visible-source suppression, anonymous/quantized player-view contacts, no hidden entity disclosure, indirect AI investigation, snapshot/replay equality, and HUD integration construction. Clean source commit `60b5947ecccc33e5cd739146657cf97b2ceb6708` produced evidence hashes `337ec0973a87277ea2857ce13b327a6319dbc0ca1df27a3a1e5c7e8ca436c528` for the automation index, `8377c2c4a6e77ee9ad07c37befb786a1130b775ad83a2abfb18e012dac643d4a` for normal runtime, and `9b4124ce6a530424d4cd1217c62be7d5ee0927d1613c503f3ccc294677aa3d6c` for stress runtime. The short normal runtime observed no live AI vibration response or local contact presentation, so those are accepted only at deterministic and Unreal integration-test boundaries. This establishes six bounded faction mechanics, not complete faction identity, balance, direct Kharuun player usability, rendered contact acceptance, a pointer-driven match, final effects/formations, network transport, broader gameplay completeness, or clean-machine installation.
