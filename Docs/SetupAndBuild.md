...
The observed current 0.33.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; ten adversarial content-compiler tests passed; the native core passed 20/20 in optimized, debug, and sanitizer configurations; and fourteen Unreal automation tests passed 14/14 with no test warning or error. Reviewed pack SHA-256 is `a5ac74b23b572f2db4baf1236738a7f09b682d0de91580336af1f5a57dbb5586`. Stable IDs still map all eight units and all eight structures into sixteen deterministic roster archetypes. Schema-12 state adds an authored Meridian Bulwark deployment profile and public deployment/facing state. Frontal attacks against allies inside the non-stacking protected footprint receive the authored 40 percent reduction, flanking bypasses it, and deployed movement uses 35 percent of base speed. Backslash-at-cursor control and a world-space barrier are integration-tested. The playable fixture remains 31 entities; the 400-unit fixture distributes line, heavy, and scout combatants across four teams while retaining 396 attack-move orders and active combat. Clean source commit `00f99388ba5d9ecd592407241ac84109c76fe12b` produced evidence hashes `3ce0c82e1a1e3339af16639ebb083ab3265c77bd6a9e4069ec7861ec6427ff04` for the automation index, `3803607cd410974976415c280f46c1d62d21ddd00218e257ab100ddba7796550` for normal runtime, and `48c679ecd789a23fcbb0e4ab7a2b98b4e4d237e1a5716b5d632f9e3c9023f81c` for stress runtime. This establishes the first bounded faction mechanic, not complete faction identity, balance, a rendered pointer-driven match, final effects/formations, network transport, broader gameplay completeness, or clean-machine installation.
