...
The observed current 0.42.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; twenty-seven adversarial content-compiler tests passed; the native core passed 27/27 in optimized, debug, and sanitizer configurations; and twenty-two Unreal automation tests passed 22/22 with no test warning or error. Reviewed pack SHA-256 remains `100f1fcd184cf94fe9b21d3f591714a2e33cc92b60f018bc6523868675156fa0`; the digest-sidecar file SHA-256 remains `9fa9b2d4effc7131def4266bc6092613272218a933043db59e883ec9a3ceb68d`; snapshot/replay schema remains 19. Clean source commit `bf98bfba3b33a05515297bed11aaa5258727bc34` produced evidence hashes `e3df99801eef191c6306e4ee01f7ac1fcda7ff0583cb132dc6798c86dab29adc` for the automation index, `18c1c3a08316cb21ddd5a56c3b73ce218214f744aacf0629c23e9f92b8aa8200` for Meridian runtime, `8a7dbdc5ef316f19dcd34d19aeaa74cb251ff5ce758bc0e0fe6943e63f711ba0` for Kharuun runtime, and `94a8c27692f24592a946b738b1e190430c725eba76cdc14196042823ecd5b911` for stress runtime. Automation now covers the F2 mapping, viewport-bounded non-overlapping row/close geometry, modal pause, Enter rejection feedback, Escape/P close path, and prior faction-research behavior. Both 32-entity faction directions booted under null RHI and observed visibility-scoped AI expansion; stress retained 400 units, four teams, 401 visibility-scoped views, 396 broad orders, and active combat. This establishes source-level technology-interface integration and regression, not actual pointer delivery, active rendered research, a complete player-driven match, balance, package behavior, network transport, broader gameplay completeness, or clean-machine installation.

## Rendered prototype boundary

The exact 0.23.1 packaged process was identified by its full executable path and visually inspected through Metal at native 2560×1440. Its responsive Glass Scar operations brief was legible without observed clipping, paused deployment, and transitioned to the battlefield and tactical HUD on Enter. The 0.23.0 package had exposed a real defect: its briefing retained a 920-pixel cap and rendered too small on the Retina display. That package is superseded; the proportional 0.23.1 layout is the accepted packaged result. Version 0.40.0 source was inspected at 1600×900 through Metal, accepting title faction cycling, the Kharuun brief, and Kharuun deployment at the recorded boundary. Version 0.41.0 then accepted the idle research count and guidance. Version 0.42.0 Metal sessions at 1600×900 visibly accepted the Meridian archive in normal and high-contrast treatments, stable no-producer rejection feedback, and the Kharuun archive. Names, costs, durations, effects, prerequisite/resource state, close control, and action guidance rendered without observed clipping or overlap. Normal/high-contrast/rejection/Kharuun screenshot SHA-256 values are `948f5805de2fcc708e041bb472fbffe7a111dbcb8340411564965b94df4c992e`, `305cede023349bb477a57e81b74115a8419a93117f015991a43f1db9bb7ded8c`, `376aa6cd0148a5bf8cee7aced74e4690ade5817c9c9c60b23215882044fce0cc`, and `399cb2e4a3655962e9560345ca4aaf04354198d7e2b1ba114f4e2f36d1c8f730`; Meridian and Kharuun visual logs hash to `4feddb78a71a002492b8d29b5a958ae03d5673ca3778152d7366e9d0b43e288e` and `205e5661fad5aa2f5140e4417094e94b5ed1f88ab2b3e0e9729698decf3e6073`. Actual coordinate-click delivery and active research progress remain unaccepted. Version 0.42.0 has not passed package or packaged-performance gates.
