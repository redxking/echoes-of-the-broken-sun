...
The next paragraph preserves the complete 0.45.0 matrix as historical evidence; later paragraphs record the focused 0.46.0 checkpoint and the current 0.48.0 source checkpoint.
