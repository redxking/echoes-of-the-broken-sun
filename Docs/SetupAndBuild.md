...
The observed current 0.32.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; eight adversarial content-compiler tests passed; the native core passed 19/19 in optimized, debug, and sanitizer configurations; and thirteen Unreal automation tests passed 13/13 with no test warning or error. Reviewed pack SHA-256 remains `46bc07c2f792417f880c988b053c2ac825013b695787b0e49da95ebddf92e949`. Stable IDs now map all eight units and all eight structures into sixteen deterministic roster archetypes. Heavy, scout, and utility categories have authored costs, statistics, population/production/construction behavior, footprints, faction display names, placeholder silhouettes, and schema-11 persistence. The playable fixture contains 31 entities; the 400-unit fixture distributes line, heavy, and scout combatants across four teams while retaining 396 attack-move orders and active combat. Clean evidence at source commit `b6683037aa83520db6674b54521703974c03d780` hashes to `b28d44530dfa94fdd3c418946b80ea8d8aaa1a30827a3a97d5cf173c0de0e2f7` for the automation index, `274493b3bf81162742a63101a26d12c4f9acdb662b8cd1d6a6c5d7c8a8422039` for normal runtime, and `0d4d68700bc785ca1596ae08598501026307dff604b0475e6c820cc7dd344e78` for stress runtime. This establishes complete baseline roster identity and production, not faction-specific abilities, balance, pointer-delivered orders in a rendered match, final effects/formations, network transport, broader gameplay completeness, or clean-machine installation.
