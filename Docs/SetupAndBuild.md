...
The observed current 0.35.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; fourteen adversarial content-compiler tests passed; the native core passed 22/22 in optimized, debug, and sanitizer configurations; and sixteen Unreal automation tests passed 16/16 with no test warning or error. Reviewed pack SHA-256 is `13d939a3f3c720c6c56adaf06c7fef43a31f3c9e1916822660951e51fc71843b`. Stable IDs still map all eight units and all eight structures into sixteen deterministic roster archetypes. Schema-14 state carries Bulwark deployment, Relay supply, and Waystone migration profiles plus their public state. The Waystone supplies five Logistics only while rooted, uproots over 40 ticks, migrates at 120 cm/s, takes 125 percent incoming damage while non-rooted, and roots over 60 ticks only when its footprint remains clear and passable. Mobile Waystones do not accept Matter delivery. Backslash, Equals, and Hyphen controls plus all three public world proxies are integration-tested, although Kharuun player selection remains absent from the current Meridian-only player scenario. The complete-roster fixture now contains 32 entities, including its previously omitted Waystone; the 400-unit fixture retains 396 attack-move orders and active combat. Clean source commit `39822a8b95ec1b4f0114590ae2f1ae142971b1cd` produced evidence hashes `e3c826ce1c66e8e95a3dda54d180accaa83cca32f26245c1a0251d423f6af1f1` for the automation index, `b03b0f6bb9b52c3a52cab6ed1fec4c99181d3cd868bfe69699870f125a2ff8ba` for normal runtime, and `4a9f492ec4be70af07c47ff3ec46717a7e705d636505607e66b8a720f4bd1ade` for stress runtime. This establishes three bounded faction mechanics, not complete faction identity, balance, Kharuun player-side usability, a rendered pointer-driven match, final effects/formations, network transport, broader gameplay completeness, or clean-machine installation.
