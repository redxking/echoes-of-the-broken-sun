...
`run_research_presentation_smoke.sh` is a Development-only evidence fixture. It supplies controlled local resources, queues the first faction technology through the ordinary deterministic command path, and requires ready, active, and complete markers. `ECHOES_LOCAL_FACTION=Kharuun` exercises the other faction. The `-EchoesResearchPresentation` behavior is compiled out of Shipping builds and must not be described as ordinary player progression or release behavior.
...
The observed current 0.43.0 source results are: `EchoesOfTheBrokenSunEditor Mac Development` compiled and linked for arm64; twenty-seven adversarial content-compiler tests passed; the native core passed 27/27 in optimized, debug, and sanitizer configurations; and twenty-two Unreal automation tests passed 22/22 with no test warning or error. Reviewed pack SHA-256 remains `100f1fcd184cf94fe9b21d3f591714a2e33cc92b60f018bc6523868675156fa0`; the digest-sidecar file SHA-256 remains `9fa9b2d4effc7131def4266bc6092613272218a933043db59e883ec9a3ceb68d`; snapshot/replay schema remains 19. Clean source commit `b9630affe5d0505500e059207d248e5fc879ad1f` produced evidence hashes `6722e50db56309f4b547037ca4310395de548666d606eb1085460478e9d86a61` for the automation index, `8aa0f7166b64760c761f28a7ae6074addf75ea07c9d4b94c0b6d61e66614d809` for Meridian runtime, `cf9dde3486eaf72df81e9d821b92ebf490a8813b0155abc58bf8a43bc2600173` for Kharuun runtime, `a048fe9e5e6f1f621c2b0b16b23ff6c08cc112719924c44f05391a2035896306` and `99dcc904aa80ca39d7e51c981832270b6f277d6e39059206e98da6751d2074e0` for the controlled Meridian and Kharuun research lifecycles, and `042a0126a49331df04053d55d1c9dd1ffaaea0e8dea8a2d363abb19c2a62f427` for stress runtime. Automation covers Up/Down mappings, focus transitions, exact focused-tier Enter routing, the modal lifecycle, shared geometry, and prior faction-research behavior. Both normal faction directions booted under null RHI and observed visibility-scoped AI expansion; both controlled research directions reached active and complete; stress retained 400 units, four teams, 401 visibility-scoped views, 396 broad orders, and active combat. This establishes source-level keyboard-navigation integration and controlled lifecycle regression, not actual pointer delivery, ordinary player-driven completion, interruption presentation, balance, package behavior, network transport, broader gameplay completeness, or clean-machine installation.

## Rendered prototype boundary

The exact 0.23.1 packaged process was identified by its full executable path and visually inspected through Metal at native 2560×1440. Its responsive Glass Scar operations brief was legible without observed clipping, paused deployment, and transitioned to the battlefield and tactical HUD on Enter. The 0.23.0 package had exposed a real defect: its briefing retained a 920-pixel cap and rendered too small on the Retina display. That package is superseded; the proportional 0.23.1 layout is the accepted packaged result. Versions 0.40.0 through 0.42.0 accepted the recorded faction-selection, idle-research, archive, high-contrast, rejection, and both-faction states. Version 0.43.0 used the explicit non-release presentation fixture in a 1600×900 Metal session. The active archive rendered Prismatic Targeting at 32% with Tier 1 focused and Tier 2 busy; after the panel closed and simulation resumed, Tier 1 rendered complete and the first incomplete Tier 2 received focus. Direct Up then Down input changed the focus boundary and visible tier feedback. No observed clipping or overlap occurred. Active/complete/Up/Down screenshot SHA-256 values are `d0aadd7cc18e757209d96302aa7e0a562bb84f099c3193be9c55e419f8576cf6`, `ebacc2746fcfb198c1ebed5fe03543e8ef28dadba835eb7992f036d7e34f8e0e`, `121de97ae9a7eb1aaad9ecc47a3f3cf3c27becf1e8eca4e4da595746e7bdc3f1`, and `a9cca1680c4e0307a99db1b7091ddfd434a62687b0746a64653d42e4269b763a`; the visual log SHA-256 is `b3b6005a0f6f8e4369ac11977703390648cdb2a9dae38ad16587737b3f9fe36d`. This accepts controlled rendered active/completed state and keyboard focus, not ordinary player-driven research, interruption presentation, pointer activation, or balance. Version 0.43.0 has not passed package or packaged-performance gates.
